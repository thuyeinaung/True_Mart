...
class ReportFinancialExcel(models.Model):
    _name = "report.true_mart_pos.report_financial_excel"
    _inherit = 'report.report_xlsx.abstract'
    
    def generate_xlsx_report(self, workbook, data, obj):
        report_obj = self.env['report.account.report_financial']
...
#                                        'bottom': True, 'top': True, 'bold': True, 'bg_color': '#bfbfbf'})
        ...
        sheet.merge_range('A1:E1', data['form']['account_report_id'][1], format1)
